     ...
     {{-- <div class="card"> --}}
       ...
       <div class="card-body">
         ...
         <section class="questions">
            ...
            <br><br>
            @foreach ($questions as $r_question)
            <section class="section">
                <div class="box11">
                  <h3 class="question_name">{{ $r_question->name }}</h3>　<!-- sectionに見出しになります　-->
                  @if ($r_question->is_challenge)
                  <span class="btn-sticky is_challenge">挑戦済み</span>
                  @endif
                  @if ($r_question->is_correct)
                  <span class="btn-sticky is_correct">クリア済み</span>
                  @endif
